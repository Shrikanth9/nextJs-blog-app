...
const BlogDetails = async({ blog }: { blog: IBlog}) => {
    const {_id: id, image, title, content, owner, totalLikes, totalComments} = blog;
    const author = owner as IUser;
    return ( 
        <article className="prose lg:prose-xl mx-3">
            ...
            <div className="my-5 flex items-center justify-end gap-2">
                ...
                />
                <p className="text-center font-semibold text-sm">By: {author.username}</p>
            </div>
