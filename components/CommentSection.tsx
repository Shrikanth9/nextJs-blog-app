    ...
    return ( 
        ...
        <div className="drawer drawer-end">
            ...
            <div className="drawer-side">
                ...
                <div className="menu p-4 w-80 bg-base-100 mb-auto gap-5 flex flex-col min-h-screen">
                    ...
                    <div className="flex flex-col gap-5 h-[calc(100vh-10rem)] overflow-y-auto">
                        { comments.map((comment) => (
                            <CommentCard key={comment._id} comment={comment}/>
                        ))}
                    </div>
                    <div className="fixed chat chat-start pt-5 bottom-2 bg-base-100">
